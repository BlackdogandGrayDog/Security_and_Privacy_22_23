...
class Client:
    def __init__(self, config):
        ...
        # Intermediate result
        self.data = {}
        # Connection status to other nodes
        self.other_client = {}

    # Establish connections with other participants
...
class ClientA(Client):
    ...
    # Calculation of encryption gradient, corresponding to step4
...
class ClientC(Client):
    ...
    def __init__(self, A_d_shape, B_d_shape, config):
        ...
        # Save the loss value in training (Tai expansion approximation)
        self.loss = []
...
def vertical_logistic_regression(X, y, X_test, y_test, config):
    ...
    # The establishment of connections between the parties involved
